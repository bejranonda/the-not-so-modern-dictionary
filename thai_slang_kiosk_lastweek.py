...
from greetings_lastweek import greeting_word
...
class SlangKiosk(QWidget):
    ...
    def init_ui(self):
        ...
        gradient.setColorAt(0.0, QColor("red").darker(200))      # 200 = มืดขึ้น 2 เท่า
        gradient.setColorAt(0.17, QColor("orange").darker(200))
        gradient.setColorAt(0.33, QColor("yellow").darker(200))
        gradient.setColorAt(0.5, QColor("green").darker(200))
        gradient.setColorAt(0.67, QColor("blue").darker(200))
        gradient.setColorAt(0.83, QColor("indigo").darker(200))
        gradient.setColorAt(1.0, QColor("violet").darker(200))
        ...
        self.header = QLabel("ปทานุกรมแบบสับ - สับส่งท้าย 📘 The Not-So Modern Dictionary - Last WEEK edition")
